...
void loop() 
{
    ...
    if(menuOption == '1') {
    // Single Color LED Weatherproof Flexi-Strip 60 LED - (1 m) - Test Code
    // The LED will turn on and fade till it is off
    for(int i=255 ; i> 0 ; i -= 5)
    {
    ledStripS.dim(i);                      // 1. Dim Led 
...
char menu()
{
    ...
    Serial.println(F("(1) Single Color LED Weatherproof Flexi-Strip 60 LED - (1 m)"));
